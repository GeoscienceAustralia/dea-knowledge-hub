...
*This is a sub-product of [**DEA Surface Reflectance (Sentinel-2B MSI)**](https://cmi.ga.gov.au/data-products/dea/825/dea-surface-reflectance-sentinel-2b-msi). See the parent product for more information.*

Reflectance data at top of atmosphere (TOA) collected by Sentinel-2B MSI sensors can be affected by atmospheric conditions, sun position, sensor view angle, surface slope and surface aspect.
...
This product takes Sentinel-2B MSI imagery captured over the Australian continent and corrects the inconsistencies across the land and coastal fringe. It achieves this using Nadir corrected Bi-directional reflectance distribution function Adjusted Reflectance (NBAR).
