...
<qgis maxScale="0" version="3.28.5-Firenze" minScale="1e+08" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0">
  ...
  <pipe>
    ...
    <rasterrenderer alphaBand="-1" opacity="1" nodataColor="" type="paletted" band="1">
      ...
      <colorPalette>
        <paletteEntry value="111" alpha="255" label="Cultivated Terrestrial Vegetation" color="#acbc2d"/>
        <paletteEntry value="112" alpha="255" label="Natural Terrestrial Vegetation" color="#0e7912"/>
        <paletteEntry value="124" alpha="255" label="Natural Aquatic Vegetation" color="#1ebf79"/>
        <paletteEntry value="215" alpha="255" label="Artificial Surface" color="#da5c69"/>
        <paletteEntry value="216" alpha="255" label="Natural Bare Surface" color="#f3ab69"/>
        <paletteEntry value="220" alpha="255" label="Water" color="#4d9fdc"/>
