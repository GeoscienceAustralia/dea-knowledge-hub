...
We are excited to announce the release of DEA Land Cover 2.0. This latest version introduces improvements to the DEA Land Cover product, enhancing the translation of over three decades of satellite imagery into evidence of how Australia’s land, vegetation and waterbodies have changed over time.
...
DEA Land Cover 1.0 will be decommissioned in June 2025.

See the [Version 2.0.0 Changelog](/data/product/dea-land-cover-landsat/) for more information.

For further detailed information about [known issues and limitations](/data/product/dea-land-cover-landsat/?tab=quality) with this product can be found in the Knowledge Hub. Some of these issues are being actively worked on.
