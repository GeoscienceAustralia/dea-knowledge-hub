...
This does **not** affect the functionality of the DEA Explorer and it does **not** affect any data within DE's data products. It only affects the display of the basemap on the DEA Explorer website. This basemap is provided by an external provider (CARTO).
