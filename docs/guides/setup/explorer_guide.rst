...
How do we know specifically **where** and **when** data is available? Before we start any analysis, we can answer this question by verifying existing data on the Digital Earth Australia (DEA) `Metadata Explorer <https://explorer.dea.ga.gov.au/>`_.

.. admonition:: Start exploring
   :class: note

   Open the `Metadata Explorer <https://explorer.dea.ga.gov.au/>`_
...
.. image:: /_media/DEA_explorer/DEA_explorer_interface_annotated.png
   :align: center
...
.. image:: /_media/DEA_explorer/DEA_explorer_select_product.png
   :align: center
...
.. image:: /_media/DEA_explorer/DEA_explorer_select_year.png
   :align: center
...
.. image:: /_media/DEA_explorer/DEA_explorer_select_month.png
   :align: center
...
.. image:: /_media/DEA_explorer/DEA_explorer_select_day.png
   :align: center
...
.. image:: /_media/DEA_explorer/DEA_explorer_available_data.png
   :align: center
...
.. image:: /_media/DEA_explorer/DEA_explorer_Adelaide.png
   :align: center
...
.. image:: /_media/DEA_explorer/DEA_explorer_dataset_metadata.png
   :align: center
