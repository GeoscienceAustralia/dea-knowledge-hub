...
:::{dropdown} Is there an easy way to learn basics of Earth Observation and DEA data?
:name: easy-way-learn-dea

If you like podcasts, you can listen to the [13 October episode of Fuzzy Logic](https://www.2xxfm.org.au/shows/fuzzy-logic/) to hear some of our scientists discuss Earth Observation and the kinds of data that DEA uses. You may want to share this podcast with friends and family who are interested!
:::
