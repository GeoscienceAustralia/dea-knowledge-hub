...
def banner():
    ...
    return f'You are viewing <strong>PR Preview {pull_request_number}</strong>, not the official <a href="{knowledge_hub_url}">DEA Knowledge Hub</a>. View the <a href="{github_url}/pull/{pull_request_number}">Pull request</a> or <a href="{deploy_log_url}">Deploy log</a> for the <strong>{pull_request_branch}</strong> branch.'
