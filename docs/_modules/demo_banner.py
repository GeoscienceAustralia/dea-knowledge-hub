def create(deploy_name, git_branch):
    introduction = f'You are viewing <strong>{deploy_name}</strong>, not the <a href="https://docs.dea.ga.gov.au/">official DEA Knowledge Hub website</a>.'
