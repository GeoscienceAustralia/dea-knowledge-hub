...
2. Select the bright blue "I want to use this" menu bar from the bottom of the left-hand column
3. Select "Create a Map"
4. Select "ArcGIS Map Viewer"

You will now have a blank map with your DEA Land Cover layer already added in, ready to use. 

5. Set the time internal to '1 year'.
