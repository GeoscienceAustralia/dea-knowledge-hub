...
![Median compositing algorithm diagram](/_files/cmi/asset-v1_digitalearthafrica+DEA101+2021+type@asset+block@median-composite_edit.png)
...
![Geomedian algorithm diagram](/_files/cmi/asset-v1_digitalearthafrica+DEA101+2021+type@asset+block@geomedian-composite_edit.png)
...
![Landsat geomedian time coverage diagram](/_files/cmi/landsat_geomedian_prodcust_time_coverage.png)
...
![Euclidean distance in three dimensions](/_files/cmi/cartesian_euclidean.JPG)
...
![Euclidean distance in three dimensions over three timesteps.](/_files/cmi/bands_euclidean.JPG)
...
![Relative relationships between Euclidean and cosine distances.](/_files/cmi/cosine_distance.JPG)
