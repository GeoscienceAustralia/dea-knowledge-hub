...
Your use of, reliance on, and any further distribution of any aspect of the DEA FMC product is entirely at your own risk.

## What this product offers

DEA FMC product is a remotely sensed proxy for the moisture content of vegetation. It estimates the percentage of water mass relative to dry mass in living vegetation based on its spectral signature. Vegetation moisture is a critical variable for understanding vegetation flammability and fire potential.
...
This product is based on the work of Dr. Marta Yebra and the team at the Bushfire Research Centre of Excellence at the Australian National University. Remotely sensed FMC was developed and delivered as the Australian Flammability Monitoring System with support from Natural Hazards Research Australia.

DEA FMC replaces the MODIS-based Australian Flammability Monitoring System, improving the spatial resolution from 500 m to 20 m.
