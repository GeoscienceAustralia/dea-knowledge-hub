...
![Overall accuracy of DEA Land Cover is 80%. 2010 accuracy is 82%, 2015 accuracy is 78%.](https://cmi.ga.gov.au/sites/default/files/inline-images/overall-accuracy_0.PNG)
...
![Table showing accuracy per class, including precision, recall, F1 score and support values per class. ](https://cmi.ga.gov.au/sites/default/files/inline-images/per-class%20accuracy.PNG)

![table showing the agreement between assessors.](https://cmi.ga.gov.au/sites/default/files/inline-images/inter-assessor-agreement.PNG)
...
![table detailing availability of different Landsat satellites since 1986 and any known issues.](https://cmi.ga.gov.au/sites/default/files/inline-images/eo-limitations-table.PNG)

![datasets within DEA used to provide essential descriptor information](https://cmi.ga.gov.au/sites/default/files/inline-images/DEA-datasets-used.PNG)
