...
The old items will be accessible for 2 weeks before being decommissioned to allow users time to transition to the new layers.

Users of the DEA Coastlines layers in Digital Atlas will need to re-add the services to any maps or processes they have created to access the 2025 data.
