# 2026-06-08 VICPWS: Vic Port Welshpool (Short), Landsat 8 overpass
...
This is a report of the field data collected on 8 June 2026 at the location of Vic Port Welshpool (Short)
...
The field data were collected along a transect approximately 500m long, rather than the usual 1ha square site.
The site was an extensive intertidal zone, measured close to low tide. The mission was performed with the UAV,
describing four 500m transects, with a spacing of approximately 6m between them. This spacing corresponds to half of
the instantaneous field-of-view of the SR3500.

Because the site is not homogeneous, this creates unnusually large uncertainty "error" bars on some plots below.
These bars should be taken to define the range of measured values for the site, rather than an uncertainty about the average.
...
"Time of field site measurements (UTC)","2026-06-08 00:39:13 to 2026-06-08 01:12:19"
"Time of overpass (UTC)", 2026-06-08 00:02:56
"GPS quality","Good"
"Reference position","146.45066667E, 38.699916S (WGS84)"
...
.. container:: 
   ...
   :download:`Download results as CSV <./SiteValidationResults-2026-06-08-VICPW.csv>`
```
...
"CA","0.012","0.017","0.059","0.039"
"blue","0.026","0.023","0.069","0.043"
"green","0.06","0.034","0.092","0.05"
"red","0.069","0.041","0.094","0.057"
"NIR","0.087","0.069","0.104","0.076"
"SWIR1","0.034","0.032","0.038","0.035"
"SWIR2","0.016","0.016","0.019","0.017"
:::
...
:::::{grid} 1 1 2 3
::::{grid-item}
:::{figure} ./RGB-2026-06-08-VICPW.png
...
::::
::::{grid-item}
:::{figure} ./SiteComparison-2026-06-08-VICPW.png
...
::::
::::{grid-item}
:::{figure} ./OverallComparison-2026-06-08-VICPW.png
...
:::::{grid} 1 1 2 2
::::{grid-item}
:::{figure} ./FCStats-2026-06-08-VICPW.png
...
::::
::::{grid-item}
:::{figure} ./FC-2026-06-08-VICPW.png
