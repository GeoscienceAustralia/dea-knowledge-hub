# 2018-06-02 DOO: Dookie, Landsat 8 and Sentinel-2A dual overpass

This is a report of the field data collected on 2 June 2018 at the location of Dookie
...
"Instrument(s) used","ASD FR4 (18616/1)"
"Time of field site measurements (UTC)","2018-06-01 00:19:57 to 2018-06-01 00:50:19"
"Time of Landsat 8 overpass (UTC)", 2018-06-02 00:01:50
"Time of Sentinel-2A overpass (UTC)", 2018-06-02 00:11:10
"GPS quality","Bad"
"Reference position","145.718636E, 36.387832S (WGS84)"
"Matchup quality for Landsat 8","Good"
...
.. container:: 
   ...
   :download:`Download results as CSV <./SiteValidationResults-2018-06-02-DOO.csv>`
```
...
"CA","0.038","0.001","0.047","0.008"
"blue","0.051","0.002","0.057","0.009"
"green","0.087","0.002","0.092","0.011"
"red","0.133","0.004","0.135","0.013"
"NIR","0.19","0.006","0.183","0.016"
"SWIR1","0.292","0.012","0.296","0.029"
"SWIR2","0.261","0.01","0.273","0.027"
:::
...
"Band","Sat Mean","Sat rms","Field mean","Field rms"
"CA","0.05","0.001","0.047","0.008"
"blue","0.06","0.003","0.06","0.01"
"green","0.093","0.003","0.092","0.011"
"red","0.146","0.006","0.139","0.014"
"RE1","0.166","0.006","0.153","0.014"
"RE2","0.181","0.006","0.166","0.015"
"RE3","0.181","0.006","0.164","0.014"
"NIR1","0.187","0.007","0.175","0.015"
"NIR2","0.2","0.006","0.181","0.016"
"SWIR2","0.309","0.012","0.296","0.03"
"SWIR3","0.275","0.009","0.272","0.027"
:::
...
::::
::::{grid-item}
:::{figure} ./SiteComparison-2018-06-02-DOO.png
...
::::
::::{grid-item}
:::{figure} ./OverallComparison-2018-06-02-DOO.png
...
:::::{grid} 1 1 2 2
::::{grid-item}
:::{figure} ./FCStats-2018-06-02-DOO.png
