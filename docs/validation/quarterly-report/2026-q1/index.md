...
* On an averaged band-by-band basis, Landsat 8 is validated to 2.4%, Landsat 9 is validated to 6.8%, Sentinel-2B is validated to 3.5% and Sentinel-2C is validated to 17.3%.
