# 2025 Q1: DEA Quarterly Validation Report
...
* On an averaged band-by-band basis, Landsat 8 is validated to 2.5%, Landsat 9 is validated to 14.0%, Sentinel-2A is validated to 2.6% and Sentinel-2B is validated to 3.7%.
